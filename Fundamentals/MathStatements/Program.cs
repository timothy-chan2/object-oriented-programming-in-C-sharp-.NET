...
namespace MathStatements
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Write("1 plus 2 is: ");
            ...
            Console.Write("223 times 31 minus 42 is: ");
            Console.WriteLine(223 * 31 - 42);

            Console.Write("4 is greater than -1 is: ");
            ...
            Console.Write("67 is greater than 4 * 5 is: ");
            Console.WriteLine(67 > 4 * 5);

            Console.Write("78 is less than 4 * 5 is: ");
